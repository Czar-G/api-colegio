        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            return _context.abrupt("return", res.status(400).json({
              message: "Ya existe un usuario regitrado con este nombre: " + req.body.username
            }));
          ...
          case 7:
            ...
            return _context.abrupt("return", res.status(400).json({
              message: "Ya existe un email regitrado con este dato: " + req.body.email
            }));
...
var checkRolesExisted = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var allRoles, dataFilter, Rolesfind, i;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            dataFilter = _context2.sent;
            //Dinamico
            //console.log(dataFilter)
            Rolesfind = dataFilter.map(function (rolsitos) {
